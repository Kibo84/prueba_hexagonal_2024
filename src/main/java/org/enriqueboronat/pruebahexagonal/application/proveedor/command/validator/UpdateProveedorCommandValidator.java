...
@Component
public class UpdateProveedorCommandValidator implements CommandValidator<UpdateProveedorCommand> {

    private static final String NULL_MESSAGE = "No puede ser null";

    @Override
    public Either<Error, UpdateProveedorCommand> validate(UpdateProveedorCommand command) {
